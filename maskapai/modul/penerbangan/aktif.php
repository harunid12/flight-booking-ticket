...
<?php
        ...
        $q = mysqli_query($koneksi, "UPDATE penerbangan SET status = '1' WHERE IDPenerbangan='$id'");
					 if($q){
		echo '<script>
                    document.getElementById("wrap-tambah").innerHTML = 
                    swal({
                        title: "SUKSES",
                        text: "Data penerbangan Berhasil Diaktifkan",
                        type: "success",
		...
		echo '<script>
                    ...
                    swal({
                        title: "GAGAL",
                        text: "Data penerbangan Gagal Dinonaktifkan",
                        type: "error",
                        showConfirmButton: false,
                        timer: 1000,   
                    },
