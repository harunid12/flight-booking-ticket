...
$query = mysqli_fetch_array(mysqli_query($koneksi, "SELECT * FROM user where IDUser='$_SESSION[IDUser]' "));
?>
<section class="content-header">
    ...
    <section class="content">
      ...
      <div class="box box-primary">
        ...
        <div class="box-body">
         <?php
  echo "<br><p>Hai $query[nama], Selamat Datang di halaman ".$_CONFIG['appname'].". <br> Silahkan klik menu pilihan yang berada di sebelah kiri untuk mengelola akun anda.</p><br>
  <br>
  <br>
  <b><table width='200px'>
    <tr>
