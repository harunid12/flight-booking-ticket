<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="?page=tujuan">Detail</a></li>
        <li class="active">here</li>
      </ol>
    </section>
<?php
  $data = mysqli_fetch_array(mysqli_query($koneksi, "SELECT * from tb_tujuan where IDTujuan='$_GET[IDTujuan]'"));
?>
        ...
        <div class="col-md-9">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#activity" data-toggle="tab">Data Lokasi Tujuan</a></li>
            </ul>
            <div class="tab-content">
              <div class="active tab-pane" id="activity">
                <!-- Post -->
                <form action="?page=tujuan_update" method="POST" class="form-horizontal">
                      <input type="hidden" class="form-control" id="IDTujuan" name="IDTujuan" value="<?php echo $data['IDTujuan']; ?>" />
