...
<?php
  include "../config/koneksi.php";
    ...
    $q = mysqli_query($koneksi, "UPDATE tb_dari SET IDBandara='$IDBandara', lokasi='$lokasi', alias='$alias'  where IDDari='$_POST[IDDari]' ");
    ...
    if($q){
        ...
        echo '<script>
                    ...
                    function(){
                        window.location.href = "?page=asal_update"
                    });
                </script>';     
    }
